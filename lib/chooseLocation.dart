...
class _ChooseLocationState extends PlacesAutocompleteState {
  ...
  Future<void> displayPrediction(Prediction p, BuildContext context) async {
    if (p != null) {
      ...
      String subadministrativecenter;
      String address;
      ...
      subadministrativecenter = place.subAdministrativeArea.toString();
      administrative = place.administrativeArea.toString();
      road = place.street.toString();

      address = road + ", " + subadministrativecenter + ", " + administrative;
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) => PlaceOrder(
                  address: address,
                  subadministrative: subadministrativecenter,
